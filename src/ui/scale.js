/*
 * src: leaflet Control.Scale.js
 * Modified to work in Webkit context and added a zoom scale indicator.
 * - Joni Rapo 2024
 */
...
export var Scale = Control.extend({
	...
	onAdd: function (map) {
        ...
        console.log('added modified version of Control.Scale.js')
	...
	_updateScale: function (scale, text, ratio) {
		...
		scale.innerHTML = text + '<br>1cm : ' + zoomScale + 'm';
	},
